...
exports.findVideoByModel = exports.findVideoByCode = exports.findThreeVideos = undefined;
...
var findVideoByModel = exports.findVideoByModel = function findVideoByModel(model, callback) {
  var regex = new RegExp(escapeRegex(model), 'gi');

  _schema.VideoCollection.find({ models: regex }, function (err, found) {
    callback(found);
  });
};